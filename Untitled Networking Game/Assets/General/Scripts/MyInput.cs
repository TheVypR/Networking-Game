...
public class MyInput
{
    ...
    {
        return Input.GetKeyDown(ps4Buttons[player]) || Input.GetKeyDown(KeyCode.H);
    }

    public static bool GetPS4Square(int player)
    {
        return Input.GetKeyDown(ps4Buttons[4+player]) || Input.GetKeyDown(KeyCode.J);
    }

    public static bool GetPS4Circle(int player)
    {
        return Input.GetKeyDown(ps4Buttons[2+player]) || Input.GetKeyDown(KeyCode.K);
    }
